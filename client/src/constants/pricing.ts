...
export const SERVICE_FEATURES = {
  today: ['1회 이용', '종합운/사랑운/재물운/건강운'],
  saju: ['1회 이용', '생시 기반 정밀 분석', '사주 해석'],
  tojung: ['1회 이용', '연간 운세', '월별 운세'],
  compatibility: ['1회 이용', '사랑 궁합', '결혼 궁합'],
  wealth: ['1회 이용', '직업별 맞춤 분석', '투자운'],
  love: ['1회 이용', '상태별 맞춤 분석', '이상형 분석']
} as const;
